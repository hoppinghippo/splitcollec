...
( function( $ ) {
	...
	function initHomepageNav(){
		...
		//$('<div/>', {
		 //   'id' : 'slideNav'
		//}).append($('<ul><li class="slideNavPrev">
		//	<a class="disabled" href="#" title="Go to previous slide">
		//	<span class="ico ico-up">↑</span></a></li><li><span id="activeSlide">'
		//	+activeSlide+'</span>/<span id="maxSlides">'
		//	+slidesCount+'
		//	</span></li><li class="slideNavNext">
		//	<a href="#" title="Go to next slide">
		//	<span class="ico ico-down">↓</span></a></li></ul>')).appendTo('body').delay(1200).fadeIn(duration);
		

	// Build HTML for Nav
		$('<nav/>', {
		    'id' : 'slideNav'
		}).append($('<ul><li class="slideNavPrev one" id="1"><a class="" href="#" title=""></a></li><li class="slideNavPrev two" id="2"><a class="" href="#" title=""></a></li><li class="slideNavPrev three" id="3"><a class="" href="#" title=""></a></li><li class="slideNavPrev four" id="4"><a class="" href="#" title=""></a></li><li class="slideNavPrev four" id="5"><a class="" href="#" title=""></a></li><li class="slideNavPrev six" id="6"><a class="" href="#" title=""></a></li></ul>')).appendTo('body').delay(1200).fadeIn(duration);
